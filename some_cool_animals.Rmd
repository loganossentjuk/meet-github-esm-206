...
Creates a tab that is given the name before it 
Anything below this with a lvl 4 header will be a new tab

#### Ringtail cat 

![Ringtail Cat (courtesy of VA Zoo)](img/ringtail_cat.jpg)
- Rotate their hind feed 180 degrees for climbing things 
...
###
This breaks from the tab section created above
